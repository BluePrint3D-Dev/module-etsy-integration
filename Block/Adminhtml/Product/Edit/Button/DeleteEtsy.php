    ...
    public function getButtonData()
    {
        ...
        return [
            ...
            'on_click' => sprintf("deleteConfirm('%s', '%s')",
                __('Are you sure you want to permanently delete this listing from your Etsy store? This will immediately free up a slot in your sync limit.'),
                $this->urlBuilder->getUrl('blueprint3d_etsy/product/deleteEtsy', ['id' => $product->getId()])
            ),
            'sort_order' => 20
        ];
    }
